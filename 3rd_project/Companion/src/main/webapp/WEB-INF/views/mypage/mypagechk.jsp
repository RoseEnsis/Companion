							...
							<tbody>
								<c:choose>
									<c:when test="${myPurchase1!=null && myPurchase2==null }">
										...
										<tr>
											<td class="imgbox"><a href="${root }order/productDetail?idx=${myPurchase1.product_id }"><img src="imgs${myPurchase1.product_thumb }" alt="80x80"></a></td>
									...
									<c:when test="${myPurchase1!=null && myPurchase2!=null }">
										...
										<tr>
											<td class="imgbox"><a href="${root }order/productDetail?idx=${myPurchase2.product_id }"><img src="imgs${myPurchase2.product_thumb }" alt="80x80"></a></td>
