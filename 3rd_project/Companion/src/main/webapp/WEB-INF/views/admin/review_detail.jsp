				...
				<thead>
					<tr>
						...
						<div class="thumb float--right">
							...
							<img width=40px height=40px alt="thumb" src="<spring:url value='../imgs${adminReviewOne.article_thumb }'/>"/>
						</div>
						</th>
					</tr>
				</thead>
					...
					<tr>
						<td>
							...
							<div class="imgB">
								...
								<img alt="원본이미지" src="<spring:url value='../imgs${adminReviewOne.article_image }'/>"/>
							</div>
						</td>
					</tr>
				</tbody>
