		...
		<section class="section">
			...
			<input type="hidden" name="product_id" value="${adminProductOne.product_id }"/>
				...
				<div class="inputArea float--left">
					<label for="img"></label>
					<img alt="썸네일" width="45px" height="45px" src="<spring:url value='imgs${adminProductOne.product_thumb }'/>">
				</div>
			...
			<div class="imgB float--left">
				...
				<img alt="원본이미지" src="<spring:url value='../imgs${adminProductOne.product_image }'/>">
			</div>	
